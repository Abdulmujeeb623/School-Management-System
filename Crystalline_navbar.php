        ...
        <div class="container-xxl bg-white p-0">
            ...
            <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top px-4 px-lg-5 py-lg-0">
                <a href="index.html" class="navbar-brand">
                    <img src="img/logo.jpg" width="25%" height="">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav mx-auto">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Team Players</a>
                            <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                                <a href="facility.html" class="dropdown-item">Management</a>
                                <a href="facility.html" class="dropdown-item">Staff</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Bursary</a>
                            <div class="dropdown-menu rounded-0 rounded-bottom border-0 shadow-sm m-0">
                                <a href="facility.html" class="dropdown-item">Pre-School/Elementary</a>
                                <a href="team.html" class="dropdown-item">Junior High School</a>
                                <a href="call-to-action.html" class="dropdown-item">Senior High School</a>
                            </div>
                        </div>
                    ...
                    <a href="Admission_Form.php"
                        class="btn btn-primary rounded-pill px-3 d-none d-lg-block">Admissions<i
